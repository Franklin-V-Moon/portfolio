...
export const travelVideoMetaData: TravelVideoMetaData[] = [
	...
	},
	{
		...
		extras: {
			...
			extraVideos: [
				{
					title: "Thailand 1 - First Trip Post-Covid",
					hostedLink: "thailand",
				},
			],
			extraLinks: [
				{
					title: "Lantern Festival Tickets, Chiang Mai",
					link: "https://yipenglanternfestival.in.th/",
				},
				{
					title: "Diving School, Koh Tao",
					link: "https://www.crystaldive.com/",
				},
				{
					title: "Cheap Authentic Muay Thai School, Koh Lanta",
					link: "https://maps.app.goo.gl/semuocAEDmdoB29j9",
				},
				{
					title: "Cheap & Small-Group Ha Giang Loop Tour, Vietnam",
					link: "https://sunflowerhagiang.com/tour",
				},
			],
			highlights: [
				{
	...
	},
{
	...
	},
	{
		...
		year: 2026,
		hostedLink: "panamaandcolombia",
		link: "panama-and-colombia",
		restricted: false,
		instagramLinks: [
