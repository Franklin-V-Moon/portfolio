	...
	return (
		<div className={styles.freeMap}>
			<Head>
				...
				<link
					rel='canonical'
					href='https://franklin-v-moon.dev/travel/world-map'
				/>
				...
				<meta
					property='og:url'
					content='https://franklin-v-moon.dev/travel/world-map'
				/>
				<meta property='og:type' content='website' />
				<meta name='twitter:card' content='summary_large_image' />
				<meta name='twitter:title' content='Franklin Von Moon Travel' />
